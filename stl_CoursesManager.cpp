...
//       {
//         List_Map<int, stl_ClassesTree>::iterator curr_time_it = to_remove.classes_array[classID];
...
//   List_Map<int, stl_ClassesTree>::iterator curr_time_it = stl_course_map[courseID].classes_array[classID];
...
//   List_Map<int, stl_ClassesTree>::iterator time_it = stl_course_map[courseID].classes_array[classID];
...
//   }
//   int index = 0;
//   for(List_Map<int, stl_ClassesTree>::const_reverse_iterator most_viewed_it = stl_most_viewed.rbegin(); most_viewed_it != stl_most_viewed.rend(); ++most_viewed_it)
//   {
//     stl_ClassesTree curr_classes = most_viewed_it->value;
//     for(stl_ClassesTree::const_iterator classes_it = curr_classes.begin(); (classes_it != curr_classes.end() && index < numOfClasses ); ++classes_it, ++index)
//     {
...
// {
//   for(List_Map<int, stl_ClassesTree>::reverse_iterator most_viewed_it = stl_most_viewed.rbegin(); most_viewed_it != stl_most_viewed.rend(); most_viewed_it++)
//   {
//     int curr_time = most_viewed_it->key;
//     stl_ClassesTree curr_classes = most_viewed_it->value;
//     for(stl_ClassesTree::const_iterator classes_it = curr_classes.begin(); classes_it != curr_classes.end(); classes_it++)
//     {
...
//   List_Map<int, stl_ClassesTree>::iterator new_time_it = stl_most_viewed.find_position(time);
...
// void CoursesManager::UpdateTimeViewed(List_Map<int, stl_ClassesTree>::iterator prev_time_it, const int courseID, const int classID, int time)
// {
//   assert(stl_course_map[courseID].classes_array[classID] != stl_most_viewed.end());
...
//   List_Map<int, stl_ClassesTree>::iterator new_time_it = stl_most_viewed.find_position(prev_time_it, time);
